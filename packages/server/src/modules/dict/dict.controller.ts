...
export class DictController {
  ...
  async createSubject(@Body() data: { code: string; name: string; maxScore?: number; gradeIds?: string[]; gradeMaxScores?: Record<string, number> }) {
  ...
  async updateSubject(
    @Param('id') id: string,
    @Body() data: { name?: string; code?: string; maxScore?: number; gradeIds?: string[]; gradeMaxScores?: Record<string, number> },
  ) {
